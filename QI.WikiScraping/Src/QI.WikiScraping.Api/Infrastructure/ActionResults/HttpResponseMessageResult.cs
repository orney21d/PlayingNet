...
namespace QI.WikiScraping.Api.Infrastructure.ActionResults
{
    /// <summary>
    /// Returns a Action result of type HttpResponseMessage as the new Web api is not backword
    /// compatiable with old HttpResponseMessage results.
    /// </summary>
